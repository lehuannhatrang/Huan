...
template<class Type>
node<Type>* AVLTree<Type>::rotateRight(node<Type> *&root) {
...
template<class Type>
node<Type>* AVLTree<Type>::rotateLeft(node<Type> *&root) {
...
template<class Type>
node<Type>* AVLTree<Type>::leftBalance(node<Type> *root, bool &taller) {
...
template<class Type>
node<Type>* AVLTree<Type>::rightBalance(node<Type> *root, bool &taller) {
...
template<class Type>
node<Type>* AVLTree<Type>::AVLInsert(node<Type> *newPtr, bool &taller) {
	if (root == NULL) {
		root = newPtr;
		taller = true;
		return root;
...
template<class Type>
node<Type>* AVLTree<Type>::deleteRightBalance(node<Type> *&root, bool &shorter) {
...
template<class Type>
node<Type>* AVLTree<Type>::deleteLeftBalance(node<Type> *&root, bool &shorter) {
...
template<class Type>
node<Type>* AVLTree<Type>::AVLDelete(int deletekey, bool &shorter, bool &success) {
	if (root == NULL) {
		shorter = false;
		success = false;
		return NULL;
